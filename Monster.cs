...
namespace DoomSurvivors
{
    public class Monster : Entity
    {
        ...
        public Monster(Sdl.SDL_Rect rect, double speed, AnimationController animationController, Entity target = null, double visionRadius = 0) : base(rect, speed, animationController)
        {
            this.target = target;
